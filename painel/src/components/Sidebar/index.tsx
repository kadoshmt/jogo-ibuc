    ...
    menuItems: [
      ...
      },
      {
        ...
        children: [
          ...
          { label: "Adicionar um usuário", route: "/dashboard/users/create" },
        ],
      },
      {
        icon: (
      ...
      },
      {
        ...
        route: "#",
        children: [
          { label: "Perguntas aprovadas", route: "/dashboard/questions" },
          { label: "Perguntas pendentes", route: "/dashboard/questions" },
          { label: "Criar uma pergunta", route: "/dashboard/users/create" },
          { label: "Criar perguntas em lote", route: "/dashboard/users/create" },
        ],
      },
      {
        icon: (
