...
const RolesSelectGroup: React.FC = () => {
    ...
    <div className="mb-4.5">
      ...
      <span className="absolute left-4 top-1/2 z-30 -translate-y-1/2">
        ...
        >
          ...
          <option value="JOGADOR" className="text-dark-6">
            Jogador
          </option>
          <option value="PROFESSOR" className="text-dark-6">
            Professor
          </option>
          <option value="COLABORADOR" className="text-dark-6">
            Colaborador
          </option>
